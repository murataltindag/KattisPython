...
if (not file_exists('ChatClient.class')) or (not file_exists('ChatServer.class')):
        sys.exit()
...
args= ['java','ChatServer',str(port)]
server_errors= open( 'server-errors.txt', 'w' )
server= subprocess.Popen( args, stderr= server_errors )

time.sleep( 1 )

shell_command= 'py input-writer.py 0 2 client1-msg.txt | java ChatClient {} >client1-recvd.txt 2>client1-errors.txt &'.format(port)
os.system( shell_command )

shell_command= 'py input-writer.py 1 2 client2-msg.txt | java ChatClient {} >client2-recvd.txt 2>client2-errors.txt'.format(port)
os.system( shell_command )
...
shell_command= 'py input-writer.py 0 2 client1-msgs.txt | java ChatClient {} >client1-recvd.txt 2>>client1-errors.txt &'.format(port)
os.system( shell_command )

shell_command= 'py input-writer.py 1 2 client2-msgs.txt | java ChatClient {} >client2-recvd.txt 2>>client2-errors.txt'.format(port)
os.system( shell_command )
...
shell_command= 'py input-writer.py 0 1 client1-msg.txt | java ChatClient {} >client1-recvd.txt 2>>client1-errors.txt &'.format(port)
os.system( shell_command )

shell_command= 'py input-writer.py 0 1 client2-msg.txt | java ChatClient {} >client2-recvd.txt 2>>client2-errors.txt &'.format(port)
os.system( shell_command )

shell_command= 'py input-writer.py 0 1 client3-msg.txt | java ChatClient {} >client3-recvd.txt 2>>client3-errors.txt'.format(port)
os.system( shell_command )
...
shell_command= 'py input-writer.py 0 1 client1-msgs.txt | java ChatClient {} >client1-recvd.txt 2>>client1-errors.txt &'.format(port)
os.system( shell_command )

shell_command= 'py input-writer.py 0 1 client2-msgs.txt | java ChatClient {} >client2-recvd.txt 2>>client2-errors.txt &'.format(port)
os.system( shell_command )

shell_command= 'py input-writer.py 0 1 client3-msgs.txt | java ChatClient {} >client3-recvd.txt 2>>client3-errors.txt'.format(port)
os.system( shell_command )
...
shell_command= 'py input-writer.py 0 1 client4-msgs.txt | java ChatClient {} >client4-recvd.txt 2>client4-errors.txt &'.format(port)
os.system( shell_command )

shell_command= 'py input-writer.py 0 1 client5-msgs.txt | java ChatClient {} >client5-recvd.txt 2>client5-errors.txt &'.format(port)
os.system( shell_command )

shell_command= 'py input-writer.py 0 1 client6-msgs.txt | java ChatClient {} >client6-recvd.txt 2>client6-errors.txt'.format(port)
os.system( shell_command )
